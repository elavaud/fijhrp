...
$baseDir = dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_FILENAME'])))))))))));
...
$PHPTHUMB_CONFIG['document_root'] = $baseDir;
...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'] . '/cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = dirname(__FILE__).'/cache/';  // set the cache directory for unprocessed source images
