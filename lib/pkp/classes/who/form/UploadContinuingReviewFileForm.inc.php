...
class UploadContinuingReviewFileForm extends Form {
	 ...
	 * Constructor.
	 */
	function UploadContinuingReviewFileForm($meetingId, $articleId) {
		parent::Form('sectionEditor/minutes/uploadContinuingReviewFile.tpl');
