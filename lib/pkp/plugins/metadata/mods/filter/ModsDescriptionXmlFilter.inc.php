...
/**
 * @defgroup plugins_metadata_mods_filter
 */

/**
 * @file classes/plugins/metadata/mods/filter/ModsDescriptionXmlFilter.inc.php
 *
 * Copyright (c) 2000-2011 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class ModsDescriptionXmlFilter
...
class ModsDescriptionXmlFilter extends Filter {
	/**
	 * Constructor
	 */
	...
	function getClassName() {
		return 'lib.pkp.plugins.metadata.mods.filters.ModsDescriptionXmlFilter';
	}
	...
	function getSupportedTransformation() {
		...
		return array(
			'metadata::plugins.metadata.mods.schema.ModsSchema(*)',
			'xml::schema(lib/pkp/plugins/metadata/mods/filter/mods.xsd)'
		);
	}
