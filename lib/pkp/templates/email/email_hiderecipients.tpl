...
{literal}
    ...
    $(document).ready(function(){
        $('#viewRecipients').click(function(){
            $('#div_recipients').show();
            $('#div_hideRecipients').show();
            $('#div_viewRecipients').hide();
                
            return false;
        });
            
        $('#hideRecipients').click(function(){
            $('#div_recipients').hide();
            $('#div_viewRecipients').show();
            $('#div_hideRecipients').hide();
...
<tr valign="top">
	...
	<td width="80%" class="value">
            <div id="div_viewRecipients"><a href="" id="viewRecipients">View all {$totalRecipients} recipient(s)</a></div>
            
            <div id="div_recipients" style="display:none;">
		...
		{/if}
            ...
            <div id="div_hideRecipients" style="display:none;"><a href="" id="hideRecipients">Hide recipient(s)</a></div>
	</td>
</tr>
<tr valign="top">
