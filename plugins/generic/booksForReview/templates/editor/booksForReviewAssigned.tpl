 ...
 *
 *}
{assign var="pageTitle" value="plugins.generic.booksForReview.editor.booksForReviewAssigned"}
...
<ul class="menu">
	...
	{if $mode == $smarty.const.BFR_MODE_FULL}
		...
		<li class="current"><a href="{url op="booksForReview" path="assigned"}">{translate key="plugins.generic.booksForReview.editor.assigned"} ({$counts[$smarty.const.BFR_STATUS_ASSIGNED]})</a></li>
