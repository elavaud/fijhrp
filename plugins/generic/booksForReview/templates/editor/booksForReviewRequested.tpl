 ...
 *
 *}
{assign var="pageTitle" value="plugins.generic.booksForReview.editor.booksForReviewRequested"}
...
<ul class="menu">
	...
	{if $mode == $smarty.const.BFR_MODE_FULL}
		<li class="current"><a href="{url op="booksForReview" path="requested"}">{translate key="plugins.generic.booksForReview.editor.requested"} ({$counts[$smarty.const.BFR_STATUS_REQUESTED]})</a></li>
