{**
 * @file plugins/generic/booksForReview/templates/editor/booksForReviewSubmitted.tpl
 *
 ...
 *
 *}
{assign var="pageTitle" value="plugins.generic.booksForReview.editor.booksForReviewSubmitted"}
...
<ul class="menu">
	...
	{/if}
	<li class="current"><a href="{url op="booksForReview" path="submitted"}">{translate key="plugins.generic.booksForReview.editor.submitted"} ({$counts[$smarty.const.BFR_STATUS_SUBMITTED]})</a></li>
