{**
 * @file plugins/generic/booksForReview/templates/author/booksForReviewSubmitted.tpl
 *
 ...
 *
 *}
{assign var="pageTitle" value="plugins.generic.booksForReview.author.booksForReviewSubmitted"}
...
<ul class="menu">
	...
	<li class="current"><a href="{url op="booksForReview" path="submitted"}">{translate key="plugins.generic.booksForReview.author.submitted"} ({$counts[$smarty.const.BFR_STATUS_SUBMITTED]})</a></li>
</ul>
