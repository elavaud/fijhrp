 ...
 *
 *}
{assign var="pageTitle" value="plugins.generic.booksForReview.author.booksForReviewMailed"}
...
<ul class="menu">
	...
	<li class="current"><a href="{url op="booksForReview" path="mailed"}">{translate key="plugins.generic.booksForReview.author.mailed"} ({$counts[$smarty.const.BFR_STATUS_MAILED]})</a></li>
