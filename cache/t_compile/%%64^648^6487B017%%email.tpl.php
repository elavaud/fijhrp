<?php /* Smarty version 2.6.26, created on 2011-05-04 18:49:58
         compiled from email/email.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'email/email.tpl', 31, false),array('modifier', 'assign', 'email/email.tpl', 51, false),array('function', 'translate', 'email/email.tpl', 47, false),array('function', 'fieldLabel', 'email/email.tpl', 63, false),)), $this); ?>
...
?>
		<?php if (is_object ( $this->_tpl_vars['temporaryFile'] )): ?><input type="hidden" name="persistAttachments[]" value="<?php echo $this->_tpl_vars['temporaryFile']->getFileId(); ?>
" /><?php endif; ?>
	<?php endforeach; endif; unset($_from); ?>
<?php endif; ?>
