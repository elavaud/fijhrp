<?php /* Smarty version 2.6.26, created on 2011-06-01 12:08:44
         compiled from author/active.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/active.tpl', 18, false),array('function', 'sort_heading', 'author/active.tpl', 18, false),array('function', 'url', 'author/active.tpl', 43, false),array('block', 'iterate', 'author/active.tpl', 27, false),array('modifier', 'escape', 'author/active.tpl', 37, false),array('modifier', 'date_format', 'author/active.tpl', 38, false),array('modifier', 'truncate', 'author/active.tpl', 40, false),array('modifier', 'strip_unsafe_html', 'author/active.tpl', 43, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'submissions1','item' => 'submission')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->assign('status', $this->_tpl_vars['submission']->getSubmissionStatus()); ?>
        ...
        <?php if ($this->_tpl_vars['status'] != PROPOSAL_STATUS_REVIEWED || $this->_tpl_vars['decision'] == SUBMISSION_EDITOR_DECISION_RESUBMIT): ?>
...
<?php endif; ?></a></td>
                <td align="right">
                    ...
                    <?php if ($this->_tpl_vars['status'] == PROPOSAL_STATUS_REVIEWED): ?>
                        <?php if ($this->_tpl_vars['decision'] == SUBMISSION_EDITOR_DECISION_ACCEPT): ?>
...
')"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.withdraw"), $this);?>
                            ...
                            <?php $this->assign('count', $this->_tpl_vars['count']+1); ?>
                        <?php endif; ?>
                    <?php elseif ($this->_tpl_vars['status'] == PROPOSAL_STATUS_EXEMPTED): ?>
