<?php /* Smarty version 2.6.26, created on 2011-04-23 22:08:27
         compiled from core:install/install.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'core:install/install.tpl', 30, false),array('function', 'url', 'core:install/install.tpl', 41, false),array('function', 'fieldLabel', 'core:install/install.tpl', 66, false),array('function', 'html_options', 'core:install/install.tpl', 69, false),array('modifier', 'assign', 'core:install/install.tpl', 30, false),array('modifier', 'escape', 'core:install/install.tpl', 79, false),)), $this); ?>
...
<form method="post" name="install" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'install'), $this);?>
">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['localeName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['localeKey'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
			...
			<?php if ($this->_tpl_vars['incompleteLocaleFound']): ?>
				<br/>
				<span class="formError">*</span>&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.locale.maybeIncomplete"), $this);?>
...
<?php if (! $this->_tpl_vars['skipMiscSettings']): ?>
<div id="miscSettings">
...
" class="button defaultButton" onclick="doSubmit()" /> <input type="submit" name="manualInstall" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "installer.manualInstall"), $this);?>
" class="button" /></p>
