<?php return array (
  ...
  'proposal.fundsRequired' => 'Funds Required (in USD)',
  ...
  'proposal.reviewedByOtherErc' => 'Has Proposal Been Reviewed By Other ERC?',
  'proposal.otherErcDecision' => 'If yes, other ERC Decision:',
  ...
  'submission.editorDecision' => 'STO Decision and Review',
...
Active is how many reviews are currently being considered or underway.',
  ...
  'sectionEditor.review.createExternalReviewer' => 'Create External Reviewer',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'notification.type.articleSubmitted' => 'A new article, "{$param}", has been submitted.',
  'notification.type.copyeditComment' => 'A copyeditor has left a comment on "{$param}".',
  'notification.type.editing' => 'Editing Events',
  'notification.type.editorDecisionComment' => 'A comment has been left on the editor decision for "{$param}".',
