...
{iterate from=submissions1 item=submission}
    ...
    {if ($status!=PROPOSAL_STATUS_REVIEWED && $status != PROPOSAL_STATUS_EXEMPTED) || $decision==SUBMISSION_EDITOR_DECISION_RESUBMIT || $status==PROPOSAL_STATUS_EXTENSION }
            ...
            <tr valign="top">
                ...
                <td>{if $submission->getDateSubmitted()}{$submission->getDateSubmitted()|date_format:$dateFormatShort}{else}&mdash;{/if}</td>
        ...
        {if ($status==PROPOSAL_STATUS_REVIEWED && $decision==SUBMISSION_EDITOR_DECISION_ACCEPT)}
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <a href="{url op="addExtensionRequest" path=$articleId}" class="action">&#187; Submit Extension Request</a><br />
                    {/if}
                    ...
                    <a href="{url op="addRawDataFile" path=$articleId}" class="action">&#187; Upload Raw Data</a><br />
                    <a href="{url op="addOtherSuppResearchOutput" path=$articleId}" class="action">&#187; Upload Other Supplementary Research Output</a><br />
