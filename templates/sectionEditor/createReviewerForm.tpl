...
<form method="post" name="reviewerForm" action="{url op="createReviewer" path=$sectionId|to_array:"create"}">
...
<p><h3>{$erc->getLocalizedTitle()}</h3><br/></p>
...
<tr valign="top">
	...
	-->
	<tr>
		<td class="label">{fieldLabel name="ercStatus" required="true" key="common.enroll"}</td>
		<td class="value">
