	...
	<table class="data" width="100%">
		...
		<tr>
			...
			<td>
				...
				{foreach from=$submissions item=submission}
						<label id="ir_principalInvestigator_{$submission.articleId}" class="ir_pi_label">{$submission.authorName|strip_unsafe_html|truncate:40:"..."}</label>						
				{/foreach}				
			</td>
		</tr>
		<tr>
			<td width="10%">Protocol Summary</td>
			<td><textarea name="ir_protocolSummary" id="ir_protocolSummary" class="textArea" rows="5" cols=40"></textarea></td>
		</tr>
		<tr>
			<td width="10%">(a) Discussion</td>
			<td><textarea name="ir_discussion" id="ir_discussion" class="textArea" rows="5" cols="40" ></textarea></td>
		</tr>
		<tr>
			<td width="10%">General Discussion</td>
			<td><textarea name="ir_generalDiscussion" id="ir_generalDiscussion" class="textArea" rows="5" cols="40" ></textarea></td>
		</tr>
		...
		<tr>
			...
			<td><textarea name="ir_scientificDesign" id="ir_scientificDesign" class="textArea" rows="5" cols="40" ></textarea></td>
		</tr>
		<tr>
			<td width="10%">Subject selection (discuss populations to be studied & recruitment
			<td><textarea name="ir_subjectSelection" id="ir_subjectSelection" class="textArea" rows="5" cols="40" ></textarea></td>
		</tr>
		<tr class="heading">
...
or condition.</td>
		...
		<tr>
			...
			<td><textarea name="ir_additionalSafeguards" id="ir_additionalSafeguards" class="textArea" rows="5" cols="40"></textarea></td>
		</tr>
		<tr>
			<td width="10%">Minimization of Risks to Subjects</td>
			<td><textarea name="ir_minimization" id="ir_minimization" class="textArea" rows="5" cols="40"></textarea></td>
		</tr>
		<tr>
			<td width="10%">Privacy and Confidentiality</td>
			<td><textarea name="ir_confidentiality" id="ir_confidentiality" class="textArea" rows="5" cols="40"></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td ><textarea name="ir_additionalConsiderations" id="ir_additionalConsiderations" class="textArea" rows="5" cols="40"></textarea>
		...
		<tr>
			...
			<td><input type="text" name="ir_stipulations" id="ir_stipulations" size="5"  /></td>
		</tr>
		<tr>
			<td width="10%">Recommendations (number of recommendations)</td>
			<td><input type="text" name="ir_recommendations" id="ir_recommendations" size="5" /></td>
		</tr>
		<tr></tr>
		<tr class="heading">
