...
{strip}
{assign var="pageTitle" value="editor.reports.meetingAttendance"}
{assign var="pageCrumbTitle" value="editor.reports.meetingAttendance"}
{include file="common/header.tpl"}
{/strip}

<ul class="menu">
	<li class="current"><a href="{url op="reportSubmissions"}">{translate key="editor.reports.submissions"}</a></li>
	<li><a href="{url op="reportMeetings"}">{translate key="editor.reports.meetingAttendance"}</a></li>
</ul>
...
<form method="post" action="{url op="meetingAttendance"}">
<p>{fieldLabel name="reviewers" required="true" key="editor.meetings.addProposalsToDiscuss"}</p>
