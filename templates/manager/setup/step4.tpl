...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td width="95%" class="value">
			...
			<p><textarea name="openAccessPolicy[{$formLocale|escape}]" id="openAccessPolicy" rows="12" cols="50" class="textArea"{if $publishingMode != $smarty.const.PUBLISHING_MODE_OPEN} disabled="disabled"{/if}>{$openAccessPolicy[$formLocale]|escape}</textarea></p>
		</td>
	</tr>
	<tr>
...
<p><textarea name="pubFreqPolicy[{$formLocale|escape}]" id="pubFreqPolicy" rows="12" cols="50" class="textArea">{$pubFreqPolicy[$formLocale]|escape}</textarea></p>
</div>
...
<p><textarea name="announcementsIntroduction[{$formLocale|escape}]" id="announcementsIntroduction" rows="12" cols="50" class="textArea">{$announcementsIntroduction[$formLocale]|escape}</textarea></p>
...
<p>
	<textarea name="copyeditInstructions[{$formLocale|escape}]" id="copyeditInstructions" rows="12" cols="50" class="textArea">{$copyeditInstructions[$formLocale]|escape}</textarea>
</p>
...
<p>
	<textarea name="layoutInstructions[{$formLocale|escape}]" id="layoutInstructions" rows="12" cols="50" class="textArea">{$layoutInstructions[$formLocale]|escape}</textarea>
</p>
...
<textarea name="refLinkInstructions[{$formLocale|escape}]" id="refLinkInstructions" rows="12" cols="50" class="textArea">{$refLinkInstructions[$formLocale]|escape}</textarea>
...
<p>
	<textarea name="proofInstructions[{$formLocale|escape}]" id="proofInstructions" rows="12" cols="50" class="textArea">{$proofInstructions[$formLocale]|escape}</textarea>
</p>
</div>
</div>
